...
def write_config_file(n1, n2, n3, n4, n5, n6, subject_attributes, object_attributes, environment_attributes, N):
    ...
    with open(r"C:\Users\Sathya\OneDrive\Desktop\BTP\spring_sem\variation\config.ini", 'w') as configfile:
        config.write(configfile)

def read_input_file():
    with open(r"C:\Users\Sathya\OneDrive\Desktop\BTP\spring_sem\variation\input.txt", "r") as file:
