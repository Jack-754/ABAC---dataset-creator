...
access_data = []
with open(r"C:\Users\Sathya\OneDrive\Desktop\BTP\spring_sem\variation\access_data.txt", "r") as file:
    for line in file:
...
with open(r"C:\Users\Sathya\OneDrive\Desktop\BTP\spring_sem\variation\rules.txt", "w") as file:
    for rule in policy:
        file.write(str(rule) + "\n")
    file.write("\n")
